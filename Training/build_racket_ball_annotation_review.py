...
KEYPOINTS = (
    ...
    ("hoopRight", "Right edge of the racket oval", "#ff3d9a", "Click the oval's rightmost edge as it appears on your screen."),
    ("ballCenter", "Center of the tennis ball", "#ffd166", "Click the middle of the ball. If you cannot clearly see it, mark it not visible."),
)
...
.keypoints{display:grid;gap:8px}.tool{display:grid;grid-template-columns:18px 1fr auto;gap:10px;align-items:start;width:100%;text-align:left;padding:11px}.tool[aria-pressed=true]{border-color:var(--lime);background:#1a3320}.swatch{width:14px;height:14px;margin-top:4px;border-radius:50%;background:var(--swatch);box-shadow:0 0 0 2px var(--court),0 0 0 3px var(--swatch)}.tool-copy strong,.tool-copy span,.tool-copy small{display:block}.tool-copy small{margin-top:3px;color:var(--muted);font-size:.76rem;line-height:1.35}.tool-copy .tool-state{margin-top:6px;color:var(--lime);font-size:.74rem;font-weight:750}.tool kbd{color:var(--muted)}.first-step{margin:0 0 12px;padding:11px 12px;background:#1a3320;border-radius:10px;color:var(--chalk);font-size:.86rem}.first-step strong{color:var(--lime)}.point-actions{display:flex;gap:8px;margin:10px 0 18px}.point-actions button{flex:1}.summary{margin:18px 0;padding-top:16px;border-top:1px solid var(--line)}.summary-row{display:flex;justify-content:space-between;gap:10px;padding:5px 0;color:var(--muted);font-size:.84rem}.summary-row strong{color:var(--chalk)}.warning{padding:12px;background:#2b2012;color:#ffe0b4;border-radius:12px;font-size:.84rem}.warning strong{color:var(--orange)}
